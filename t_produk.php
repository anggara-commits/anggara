...
// Logika untuk membuat kode produk otomatis
...
// Proses simpan data saat tombol simpan diklik
if (isset($_POST['simpan'])) {
    ...
    if (!in_array($extension, $allowed_extensions)) {
        ...
        // Enkripsi nama file gambar agar unik
...
<body>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Galang Rangga</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
